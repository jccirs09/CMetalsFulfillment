...
{
    /// <inheritdoc />
    public partial class InitialBranchAuthAndGates : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PoundsPerSquareFoot = table.Column<decimal>(type: "TEXT", precision: 18, scale: 4, nullable: true),
                    CoilItemCode = table.Column<string>(type: "TEXT", nullable: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BreakRulesJson = table.Column<string>(type: "TEXT", nullable: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BranchSettings_PickPackStations_DefaultPickPackStationId",
                        column: x => x.DefaultPickPackStationId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingRegionId = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BranchSettings_DefaultPickPackStationId",
                table: "BranchSettings",
                column: "DefaultPickPackStationId");
